...
class cm_uspsv4 {
	...
	function __construct() {
		...
		if(file_exists(JPATH_ADMINISTRATOR.'/components/com_virtuemart/classes/shipping/uspsv4.cfg.php')) {
			require_once JPATH_ADMINISTRATOR.'/components/com_virtuemart/classes/shipping/uspsv4.cfg.php';
			$this->shipping_list = array();
			for($i=0; $i<23; $i++) {
	...
	function get_module_name() { return 'USPS V4'; }
