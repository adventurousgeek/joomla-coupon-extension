...
<div class="wrap">
	<h1 class="wp-heading-inline"><?php echo AC()->lang->__( 'Gift Certificate Products' ); ?></h1>
	<a href="#/cmcoupon/giftcert/edit" class="page-title-action"><?php echo AC()->lang->__( 'Add New' ); ?></a>
</div>
