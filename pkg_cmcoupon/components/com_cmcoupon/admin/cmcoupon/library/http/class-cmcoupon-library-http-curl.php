 ...
 */
class Cmcoupon_Library_Http_Curl {
	...
	protected function setup_handle( $url, $headers, $data, $options ) {
		...
		if ( 1.1 === $options['protocol_version'] ) {
	 ...
	 *
	 * @param string $capabilities test the capability of this transport.
